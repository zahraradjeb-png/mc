...
function buildSellerDrawer(user, root) {
  ...
  drawer.innerHTML = `
    ...
    <div class="gsd-body">
      ...
      <a href="${root}src/seller/orders.html"       class="gsd-link"><i class="fas fa-shopping-bag"></i> Mes commandes</a>
      <a href="${root}src/seller/dashboard.html"    class="gsd-link"><i class="fas fa-store"></i> Ma boutique</a>
      <a href="${root}src/seller/products/create.html"  class="gsd-link"><i class="fas fa-plus-circle"></i> Ajouter un produit</a>
      <a href="${root}src/seller/reviews.html"      class="gsd-link"><i class="fas fa-star"></i> Avis clients</a>

      <div class="gsd-sep"></div>
      <div class="gsd-section-label">Compte</div>
      <a href="${root}src/seller/dashboard.html"   class="gsd-link"><i class="fas fa-chart-line"></i> Tableau de bord</a>
      <a href="${root}src/seller/settings.html"    class="gsd-link"><i class="fas fa-user-cog"></i> Paramètres</a>
    </div>
